namespace Talegen.PureBlue.Models.Channels.Facebook
{
    ...
    /// <summary>
    /// This class implements the channel interface class to support a facebook page channel.
    /// </summary>
    /// <seealso cref="Talegen.PureBlue.Models.IChannel" />
    public class FacebookPageChannel : IChannel
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FacebookPageChannel" /> class.
        /// </summary>
        public FacebookPageChannel()
            : this(Guid.Empty)
        {
        }
        ...
        public FacebookPageChannel(Guid id, string name = "", string description = "")
        {
            this.Id = id;
            this.Type = ChannelType.FacebookPage;
            this.Name = name;
            ...
            this.BestPractice = new ChannelBestPractice
            {
                ...
                IncludeMedia = true,
                MinMessageLegnth = 70,
                MaxMessageLegnth = 111,
                MaxPostsPerDay = 2,
                MediaDimensions = new Dictionary<string, System.Drawing.Rectangle>()
                {
                    {"Image_8x10", new System.Drawing.Rectangle { Width = 1200, Height = 1500 }},
                    {"Image_Instagram", new System.Drawing.Rectangle { Width = 1080, Height = 1350 }},
                    {"Image_LinkShare", new System.Drawing.Rectangle { Width = 1200, Height = 630 }}
                },
                PostDateTimes = new List<BestPostDayTime>
                {
                    new BestPostDayTime
                    {
                        ...
                        TimeRanges = new List<DateTimeRange> { new DateTimeRange { Start = DateTime.Parse("11:00 AM"), End = DateTime.Parse("1:00 PM") } }
                    }
                }
            };
        }
